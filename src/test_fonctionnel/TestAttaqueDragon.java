...
public class TestAttaqueDragon {
	public static void main(String[] args) {
		...
		System.out.print(dragonNoir.cracheBouleFeu(tristan));
		System.out.print(dragonNoir.cracheBouleFeu(tristan));
		System.out.print(dragonNoir.cracheBouleFeu(perceval));
		System.out.print(dragonNoir.cracheBouleFeu(perceval));
		System.out.print(dragonNoir.cracheBouleFeu(lancelot));
		System.out.print(dragonNoir.cracheBouleFeu(lancelot));
		System.out.print(dragonNoir.cracheBouleFeu(hector));
		System.out.print(dragonNoir.cracheBouleFeu(hector));
		System.out.print(dragonNoir.cracheBouleFeu(yvain));
		System.out.print(dragonNoir.cracheBouleFeu(yvain));
		System.out.print(dragonNoir.cracheBouleFeu(arthur));
